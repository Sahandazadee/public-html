...
| **ESP32 Persian Masterclass** | esp32-masterclass/ | [open](https://sahandazadee.github.io/public-html/esp32-masterclass/) | 22 درس ESP32 از صفر تا IoT (کارگاه عملی، موتورها، FreeRTOS/OTA، همه مدل‌های ESP32) + نقشه پایه، واژه‌نامه، جعبه‌ابزار و لیست خرید، برگه خلاصه PDF؛ فارسی RTL |
