...
(function () {
  ...
  var R = [
    ...
    ["GPIO17", 17, ["safe"], "همه‌کاره، پیش‌فرض TX2 برای Serial2 (مثلا ماژول GPS). روی ماژول WROVER به PSRAM وصل است."],
    ["GPIO16", 16, ["safe"], "همه‌کاره، پیش‌فرض RX2 برای Serial2. روی ماژول WROVER به PSRAM وصل است."],
